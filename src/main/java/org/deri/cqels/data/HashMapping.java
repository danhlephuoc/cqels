...
public class HashMapping extends MappingBase {
    ...
    public HashMapping(ExecContext context) {
        super(context);
        this.hMap = new HashMap<Var, Long>();
    }

    public HashMapping(ExecContext context, Map<Var, Long> hMap) {
        super(context);
        this.hMap = hMap;
    }

    public HashMapping(ExecContext context, Map<Var, Long> hMap, Mapping parent) {
    ...
    public Iterator<Var> vars() {
        if (hMap instanceof MappingBase) {
            return IteratorConcat.concat(((MappingBase) hMap).vars(), super.vars());
        }
