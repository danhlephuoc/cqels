...
import org.deri.cqels.lang.cqels.ElementRefreshableNamedGraph;

import org.deri.cqels.lang.cqels.ElementRefreshableStreamGraph;
...
public class LogicCompiler {
    ...
    public OpRouter compileModifiers(Query query, OpRouter through) {
    ...
    protected Op compileElementGraph(ElementNamedGraph eltGraph) {
        ...
        if (eltGraph instanceof ElementRefreshableNamedGraph) {
            return new OpRefreshableGraph(graphNode, sub, ((ElementRefreshableNamedGraph) eltGraph).getDuration());
        } else if (eltGraph instanceof ElementRefreshableStreamGraph) {
            return new OpRefreshableStreamGraph(graphNode, sub, ((ElementRefreshableStreamGraph) eltGraph).getDuration());
        } else {
