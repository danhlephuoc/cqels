...
public class TimeWindow extends PhysicalOpBase implements AWB {
	...
	public TimeWindow(ExecutorService exec, DomainIndex[] indexes, Var[] vars, long duration, long slide){
		super();
	...
	public void insert(MU m) 
	{
		...
		if (!buff.isEmpty()) {
			while ((curTime - duration) > buff.peekFirst().timestamp ) {
