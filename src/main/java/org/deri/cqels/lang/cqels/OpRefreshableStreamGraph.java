 ...
 */
public class OpRefreshableStreamGraph extends OpGraph implements OpRefreshable {

    private final DurationSet duration;

    public OpRefreshableStreamGraph(Node node, Op pattern, DurationSet duration) {
        super(node, pattern);
    ...
    public Op copy(Op newOp) {
        return new OpRefreshableStreamGraph(getNode(), newOp, duration);
    }
