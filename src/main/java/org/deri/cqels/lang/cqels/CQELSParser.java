...
getQuery().setOffset(integerValue(t.image)) ;
  ...
  final public Node BindingValue() throws ParseException {Node n ; String iri ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:{
...
// Optional SEMICOLON
  ...
  final public void Update1() throws ParseException {Update up ;
...
{if ("" != null) return new UpdateCopy(src, dest, silent) ;}
  ...
  final public void Meta() throws ParseException {QuadDataAcc qd = new QuadDataAcc() ;
    jj_consume_token(META);
    QuadData(qd);
  }

  final public Update InsertData() throws ParseException {QuadDataAcc qd = new QuadDataAcc() ; Token t ;
...
finishDataInsert(qd, t.beginLine, t.beginColumn) ;
    {if ("" != null) return new UpdateDataInsert(qd) ;}
    throw new Error("Missing return statement in function");
  }

  final public Update DeleteData() throws ParseException {QuadDataAcc qd = new QuadDataAcc() ; Token t ;
...
finishDataDelete(qd, t.beginLine, t.beginColumn) ;
    {if ("" != null) return new UpdateDataDelete(qd) ;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return up ;}
  ...
  final public Update ModifyOld() throws ParseException {UpdateModify up = new UpdateModify() ; String iri ; Template template ; Element el ;
...
up.setHasDeleteClause(true) ;
  ...
  final public void InsertClause(UpdateModify up) throws ParseException {QuadAcc qp = up.getInsertAcc() ;
...
up.setHasInsertClause(true) ;
  ...
  final public void OptionalIntoTarget(QuadAcc qp) throws ParseException {String iri ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:
...
Node gn = createNode(iri) ; setAccGraph(qp, gn) ;
  ...
  final public void OptionalFromTarget(QuadAcc qp) throws ParseException {String iri ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:
...
//Ground data : As QuadPattern but don't allow variables.
  ...
  final public void QuadsNotTriples(QuadAcc acc) throws ParseException {Node gn ; Node prev = acc.getGraph() ;
    jj_consume_token(GRAPH);
    gn = VarOrIRIref();
setAccGraph(acc, gn) ;
    jj_consume_token(LBRACE);
...
{if ("" != null) return new ElementOptional(el) ;}
  ...
  final public Element GraphGraphPattern() throws ParseException {Element el ; Node n ; DurationSet refreshDurations = null;
    jj_consume_token(GRAPH);
    n = VarOrIRIref();
    refreshDurations = RefreshPattern();
    el = GroupGraphPattern();
{if ("" != null) return (refreshDurations == null) ? new ElementNamedGraph(n, el) : new ElementRefreshableNamedGraph(n, el, refreshDurations) ;}
    throw new Error("Missing return statement in function");
  }

  final public Element StreamGraphPattern() throws ParseException {Element el ; Node n ; Window w; DurationSet refreshDurations = null;
    jj_consume_token(STREAM);
    n = VarOrIRIref();
if (n.isVariable()) refreshDurations = RefreshPattern();
    w = WindowPattern();
    el = GroupGraphPattern();
{if ("" != null) return (refreshDurations == null) ? new ElementStreamGraph(n, w, el) : new ElementRefreshableStreamGraph(n, w, el, refreshDurations) ;}
    throw new Error("Missing return statement in function");
  }

  final public DurationSet RefreshPattern() throws ParseException {DurationSet durations = null; Duration duration;
    if (jj_2_2(2)) {
      jj_consume_token(LBRACKET);
      jj_consume_token(REFRESH);
durations = new DurationSet();
      label_21:
      while (true) {
...
{if ("" != null) return durations;}
    throw new Error("Missing return statement in function");
  }

  final public Window WindowPattern() throws ParseException {Window window;
    jj_consume_token(LBRACKET);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NOW:{
...
{if ("" != null) return window;}
  ...
  final public Window RangeWindowPattern() throws ParseException {DurationSet durations = new DurationSet() ; Duration duration; Duration slideDuration = null;
...
{if ("" != null) return new RangeWindow(durations,slideDuration);}
    throw new Error("Missing return statement in function");
  }

  final public Duration DurationPattern() throws ParseException {Token t;
    t = jj_consume_token(DURATION);
{if ("" != null) return getDuration(t.image);}
    throw new Error("Missing return statement in function");
  }

  final public Window TripleWindowPattern() throws ParseException {Token t;
    jj_consume_token(TRIPLES);
    t = jj_consume_token(INTEGER);
{if ("" != null) return new TripleWindow(integerValue(t.image));}
    throw new Error("Missing return statement in function");
  }

  final public Element ServiceGraphPattern() throws ParseException {Element el ; Node n ; boolean silent = false ; DurationSet refreshDurations = null;
...
silent=true;
    ...
    refreshDurations = RefreshPattern();
    el = GroupGraphPattern();
{if ("" != null) return (refreshDurations == null) ? new ElementService(n, el, silent) : new ElementRefreshableService(n, el, silent, refreshDurations) ;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new ElementAssign(v, expr) ;}
  ...
  final public Element FetchGraph() throws ParseException {Node n ;
    jj_consume_token(FETCH);
    n = VarOrIRIref();
{if ("" != null) return new ElementFetch(n) ;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new E_Function(fname, a) ;}
  ...
  final public ExprList ArgList() throws ParseException {Expr expr ; boolean distinct = false ;
...
{if ("" != null) return args ;}
  ...
  final public ExprList ExpressionList() throws ParseException {Expr expr = null ; ExprList args = new ExprList() ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NIL:{
      jj_consume_token(NIL);
      break;
...
// -------- Entry point: TriplesSameSubjectPath
  ...
  final public void PropertyListNotEmptyPath(Node s, TripleCollector acc) throws ParseException {Path path = null ; Node p = null ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:
...
// Property (if no bNodes) + DESCRIBE
  final public Node VarOrIRIref() throws ParseException {Node n = null ; String iri ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VAR1:
    case VAR2:{
      n = Var();
...
{if ("" != null) return new E_SHA1(expr1) ;}
    ...
    case SHA224:{
      ...
      expr1 = Expression();
      jj_consume_token(RPAREN);
{if ("" != null) return new E_SHA224(expr1) ;}
      break;
      }
    case SHA256:{
...
// by expanding out FunctionCall()
  final public Expr IRIrefOrFunction() throws ParseException {String iri ; ExprList a = null ;
...
// The case of "?var()" or just "?var"
  final public Expr VarOrFunction() throws ParseException {Var v ; ExprList a = null ;
    v = Var();
...
if ( a == null ) {if ("" != null) return ev ;}
    {if ("" != null) return new E_FunctionDynamic(ev, a) ;}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_66()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7200000,0x180000,0x180000,0x0,0xc00000,0xc00000,0xe00,0x0,0x6e00,0x6e00,0x6e00,0x0,0x0,0x7e00,0x0,0x6e00,0x6e00,0x0,0x0,0x0,0xe00,0x0,0x0,0x0,0x20000000,0x18000000,0x6e00,0x0,0x6e00,0xe00,0x6e00,0x0,0x6e00,0x6e00,0x10000000,0x8000000,0x18000000,0x6000,0x0,0xe00,0x0,0x80000000,0xe00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe00,0x0,0x0,0x0,0xe00,0x0,0xe00,0xe00,0x0,0xe00,0x0,0x0,0x7e00,0x0,0x0,0x7e00,0x7e00,0x7e00,0x0,0x200000,0x7e00,0x0,0x0,0x7e00,0x7e00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe00,0x400000,0x0,0x0,0x0,0x0,0x7e00,0x0,0x7e00,0x0,0x46e00,0x46e00,0x0,0x46e00,0x7e00,0x46e00,0x0,0x46e00,0x46e00,0x46e00,0x0,0x0,0x0,0x0,0x40e00,0x0,0x0,0x0,0x0,0x40e00,0x0,0x40e00,0x40e00,0x40e00,0x40e00,0x0,0x7e00,0x7e00,0x7e00,0x6e00,0x6000,0x1e00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6e00,0x6e00,0x0,0x0,0x0,0x0,0x400000,0x6e00,0x400000,0x400000,0x400000,0x400000,0x400000,0x400000,0x0,0x0,0x0,0x0,0x8000,0x8000,0x0,0x0,0x0,0x0,0x0,0x0,0xe00,0xc00,0x1000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x10,0x0,0x0,0x600000,0x800000,0xf0600000,0xf0600000,0xf0600000,0x10,0x10,0x0,0x30,0x0,0x0,0x10,0x20,0x10,0x8,0x20,0x1000000,0x2000000,0x0,0x0,0x600000,0x800000,0x600000,0x600000,0x600006,0x6,0x600000,0x600006,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x8,0x80,0x80,0x88,0x88,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7f4180,0x0,0x0,0x0,0x0,0x7f4180,0x0,0xc00,0x0,0x3000,0x3000,0x0,0x8000,0x600000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0600000,0xf0600000,0x0,0x600000,0x0,0x0,0x0,0xf0600000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0xffffef60,0x0,0xffffef6d,0xffffef6d,0xffffef6d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffef60,0x0,0xffffef60,0xffffef60,0xffffef60,0x0,0xffffef60,0xffffef60,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffef60,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffef6d,0xffffef6d,0x0,0xffffef60,0x0,0x0,0x0,0xffffef6d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x7fbffff,0x0,0x7fbffff,0x7fbffff,0x7fbffff,0x0,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1fbffff,0x0,0x1fbffff,0x1fbffff,0x1fbffff,0x0,0x1fbffff,0x1fbffff,0x0,0x0,0x0,0x0,0x0,0x6000000,0x0,0x0,0x6000000,0x0,0xf0000000,0x0,0xf0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x30000000,0x0,0x0,0x20000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6000000,0x0,0x0,0x6000000,0x6000000,0x6000000,0x0,0x0,0x6000000,0x0,0x0,0x6000000,0x6000000,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x1fbffff,0x0,0x0,0x0,0x0,0x0,0x6000000,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6000000,0x6000000,0x6000000,0x0,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7fbffff,0x7fbffff,0x0,0x1fbffff,0x0,0x0,0x0,0x7fbffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6000000,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0xff40000,0x0,0xff40000,0xff40000,0xff40000,0x0,0x0,0xff40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff40000,0x0,0x0,0xff40000,0x100,0x84ff,0x0,0x84ff,0x100,0x200,0x0,0x800,0x200,0x200,0x200,0x200,0x200,0x200,0x8000,0x0,0x0,0x10000,0x0,0x0,0x0,0x800,0x800,0x0,0x0,0x0,0x0,0x2000,0x6000,0x6000,0xff40000,0x0,0x0,0xff40000,0xff40000,0xff40000,0x0,0x0,0xff40000,0x0,0x0,0xff40000,0xff40000,0x0,0x0,0x80000,0x4000,0x80000,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff40000,0x0,0xff40000,0x0,0x0,0x0,0x0,0x0,0xff40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000,0x0,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff40000,0xff40000,0xff40000,0x0,0x0,0xff40000,0x0,0x0,0x0,0x0,0xfc00000,0xfc00000,0x0,0x0,0xfc00000,0x0,0x0,0xff40000,0xff40000,0x0,0x0,0x0,0x0,0x0,0xff40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff40000,0x340000,0x1c00000,0xe000000,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0xf,0x0,0x1f,0x1f,0x1000001f,0x0,0x0,0xa5f,0x80,0x0,0x10000000,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x10,0x10,0x10,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x50,0xf,0x50,0x0,0xf,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa5f,0x0,0x4000,0xa5f,0xa5f,0xa5f,0x4000,0x0,0xa5f,0x80,0x4000,0xa5f,0xa5f,0x4000,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x2000,0x50,0x2000,0x50,0xa5f,0x4000,0xa5f,0x1000,0x0,0x0,0x2000,0x0,0xa5f,0x200010,0x1000,0x200010,0x200010,0x0,0x0,0x20000000,0x20000000,0x14000080,0x200010,0x100,0x2100,0x2000,0x14000080,0x200010,0x0,0x0,0x10,0x0,0x0,0x210,0xa5f,0xa5f,0x84f,0x0,0x0,0x84f,0x1000000,0x2000000,0x1f8000,0x1f8000,0xc000000,0x0,0x30000000,0x30000000,0xc000000,0x30000000,0x30000000,0xc20001f,0x1f,0x50,0x0,0x2000,0x2000,0x0,0x1c20001f,0x0,0x0,0x0,0x0,0x0,0x0,0x1000,0x0,0x50,0x50,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0xf,0x0,0x0,0x800,};
   }
   private static void jj_la1_init_6() {
      jj_la1_6 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x4,0x4,0x0,0x2,0x4,0x4,0x20,0x4,0x0,0x0,0x0,0x20,0x0,0x2,0x4,0x4,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
